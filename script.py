# Create the main web-based analysis script
...
<head>
    ...
    <title>Nifty 50 Technical Analysis - {report['analysis_date']}</title>
    ...
    <nav class="navbar navbar-dark bg-primary">
        <div class="container">
            ...
            <span class="navbar-text">
                ...
                Last Updated: {report['analysis_date']}
            </span>
        </div>
    </nav>
    ...
    <div class="container-fluid py-4">
            ...
            <div class="col-md-3">
                <div class="card border-0 shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <h3 class="card-title text-primary">₹{report['market_data']['current_price']:,.2f}</h3>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card border-0 shadow-sm">
                    <div class="card-body text-center">
                        <h6 class="card-subtitle mb-2 text-muted">Overall Trend</h6>
                        <h3 class="card-title" style="color: {trend_color}">{report['technical_analysis']['overall_trend']}</h3>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card border-0 shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <h3 class="card-title" style="color: {recommendation_color}">{report['recommendation']}</h3>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card border-0 shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <h3 class="card-title text-warning">{report['risk_assessment']['level']}</h3>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="analysis-card short-term">
                                    <div class="analysis-header">
                                        <h6><i class="fas fa-tachometer-alt me-2"></i>Short-term (5D)</h6>
                                        <span class="signal-badge signal-{report['technical_analysis']['short_term']['signal'].lower()}">{report['technical_analysis']['short_term']['signal']}</span>
                                    </div>
                                    <div class="strength-indicator">
                                        <small class="text-muted">Signal Strength:</small>
                                        <div class="strength-bars">
                                            {'<span class="strength-bar active"></span>' * report['technical_analysis']['short_term']['strength']}
                                            {'<span class="strength-bar"></span>' * (2 - report['technical_analysis']['short_term']['strength'])}
                                        </div>
                                    </div>
                                    <div class="analysis-metrics">
                                        ...
                                        <div class="metric">
                                            ...
                                            <span class="{'text-success' if report['technical_analysis']['short_term']['price_vs_5dma'] > 0 else 'text-danger'}">{report['technical_analysis']['short_term']['price_vs_5dma']:+.2f}%</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="analysis-card medium-term">
                                    <div class="analysis-header">
                                        <h6><i class="fas fa-chart-line me-2"></i>Medium-term (50D)</h6>
                                        <span class="signal-badge signal-{report['technical_analysis']['medium_term']['signal'].lower()}">{report['technical_analysis']['medium_term']['signal']}</span>
                                    </div>
                                    <div class="strength-indicator">
                                        <small class="text-muted">Signal Strength:</small>
                                        <div class="strength-bars">
                                            {'<span class="strength-bar active"></span>' * report['technical_analysis']['medium_term']['strength']}
                                            {'<span class="strength-bar"></span>' * (2 - report['technical_analysis']['medium_term']['strength'])}
                                        </div>
                                    </div>
                                    <div class="analysis-metrics">
                                        <div class="metric">
                                        ...
                                        <div class="metric">
                                            <span>Price vs MA:</span>
                                            <span class="{'text-success' if report['technical_analysis']['medium_term']['price_vs_50dma'] > 0 else 'text-danger'}">{report['technical_analysis']['medium_term']['price_vs_50dma']:+.2f}%</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Long-term Analysis -->
                            <div class="col-md-4 mb-3">
                                <div class="analysis-card long-term">
                                    <div class="analysis-header">
                                        <h6><i class="fas fa-chart-area me-2"></i>Long-term (200D)</h6>
                                        <span class="signal-badge signal-{report['technical_analysis']['long_term']['signal'].lower()}">{report['technical_analysis']['long_term']['signal']}</span>
                                    </div>
                                    <div class="strength-indicator">
                                        <small class="text-muted">Signal Strength:</small>
                                        <div class="strength-bars">
                                            {'<span class="strength-bar active"></span>' * report['technical_analysis']['long_term']['strength']}
                                            {'<span class="strength-bar"></span>' * (2 - report['technical_analysis']['long_term']['strength'])}
                                        </div>
                                    </div>
                                    <div class="analysis-metrics">
                                        <div class="metric">
                                        ...
                                        <div class="metric">
                                            <span>Price vs MA:</span>
                                            <span class="{'text-success' if report['technical_analysis']['long_term']['price_vs_200dma'] > 0 else 'text-danger'}">{report['technical_analysis']['long_term']['price_vs_200dma']:+.2f}%</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="row text-center">
                            ...
                            <div class="col-md-3">
                                <div class="stat-item">
                                    <h4 class="text-info">{report['market_data']['date']}</h4>
                                    <small class="text-muted">Market Date</small>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="stat-item">
        ...
        <div class="row">
            <div class="col-12">
                <div class="alert alert-warning" role="alert">
                    <h6 class="alert-heading"><i class="fas fa-exclamation-triangle me-2"></i>Important Disclaimer</h6>
                    <p class="mb-0">
                        This analysis is for educational purposes only and should not be considered as financial advice. 
                        The technical analysis is based on historical price data and mathematical indicators from the research paper 
                        <em>"Comparative Technical Analysis and Prediction of Nifty-50 Performance"</em>. 
        ...
        <footer class="text-center mt-4 py-3 border-top">
            <small class="text-muted">
                Powered by GitHub Actions | Research-based Technical Analysis
                <br>
                Generated automatically every market day at 6:30 AM IST
            </small>
        </footer>
    </div>
...
def generate_level_list(levels, level_type):
    ...
    for i, level in enumerate(levels):
        html += f'<div class="level-item">'
        html += f'<span class="level-number">{i+1}</span>'
        html += f'<span class="level-value">₹{level:,.2f}</span>'
        html += f'</div>'
    html += '</div>'
...
def main():
    ...
    try:
        ...
        logger.info("Web page generated successfully")
...
print("✅ Created main_web.py - Web-based analysis script")